...
function Article() {
  ...
  useEffect(() => {
    fetch(`https://blog-app-backend-beryl.vercel.app/blogApi`)
          ...
          <>
            ...
            <div className="articleBottom">
              ...
              <div className="article-wrap">
                {data
                  .filter(
                    (value) => value.id !== path && value.category === categor
                  )
                  .map((item) => (
                    <div key={item.id} className="article-bottom-main-box">
                      <Link to={`/article/${item.id}`}>
                        <img
                          className="article-bottom-img"
                          src={item.image}
                          alt=""
                        />
                      </Link>
                      ...
                      <div className="article-bottom-name">
                        <div className="article-bottom-left">
                          <img
                            className="article-bottom-left-img"
                            src={item.avatar}
                            alt=""
                            width={"60px"}
                          />
